...
def test_deberta_pii_extractor():
    text = """
...
"""
    ...
    extractor = HFEntityExtractor(model_path="lakshyakh93/deberta_finetuned_pii", type_mapping=TYPE_MAPPING)
    ...
    assert len({entity.entity_type for entity in entities}) == 2
